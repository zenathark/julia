...
"""
    SubString(s::AbstractString, i::Integer, j::Integer=endindex(s))
...
SubString(s::AbstractString, i::Integer, j::Integer=endindex(s)) = SubString(s, Int(i), Int(j))
...
SubString(s::AbstractString) = SubString(s, 1, endindex(s))
SubString{T}(s::T) where {T<:AbstractString} = SubString{T}(s, 1, endindex(s))
