function _precompile_()
    ...
    precompile(Tuple{typeof(Core.Inference.isbits), REPL.LineEdit.EmptyCompletionProvider})
    precompile(Tuple{typeof(Core.Inference.isbits), REPL.LineEdit.EmptyHistoryProvider})
    ...
    precompile(Tuple{typeof(Core.Inference.isbits), REPL.REPLCompletionProvider})
    precompile(Tuple{getfield(Core, Symbol("#kw#Type")), Array{Any, 1}, Type{REPL.LineEdit.Prompt}, String})
    precompile(Tuple{typeof(Core.Inference.isbits), REPL.ShellCompletionProvider})
    ...
    precompile(Tuple{typeof(Core.Inference.isbits), LatexCompletions})
    ...
    precompile(Tuple{typeof(__atreplinit), REPL.LineEditREPL})
